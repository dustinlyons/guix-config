...
ln -fs ~/.config/vim/colors/theme.vim ~/.vim/colors/theme.vim
ln -fs ~/.config/vim/.vimrc ~/.vimrc
...
*** Emacs
kost of my configuration is defined within Emacs.org, however, in some cases where it makes sense we have supporting files here.

**** Guix Packages

#+BEGIN_SRC scheme :noweb-ref packages-manifest :noweb-sep ""
;; "emacs" ;; defined in emacs manifest
#+END_SRC
