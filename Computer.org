...
# This script created from Computer.org
  ...
  (operating-system
    ...
    (hosts-file
      (plain-file "hosts"
        ...
        (string-append
         "---------- This file is generated by guix-config/Computer.org ----------\n"
...
sudo -E ln -fs ~/.config/printers/printers.conf /etc/cups/printers.conf && \
    echo -e "${GREEN_TERMINAL_OUTPUT}--> [Polybar] Linked printers.conf.${CLEAR}"
