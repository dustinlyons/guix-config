#+TITLE: System - Desktop Definition
#+STARTUP: content
...
#+begin_src scheme :tangle build/manifest/browsers.scm :noweb yes
;; Everyday tools I use for surfing the web
(specifications->manifest
  '(
    <<packages-browsers-manifest>>
  ))
#+end_src
